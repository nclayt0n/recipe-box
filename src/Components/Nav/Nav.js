    ...
    render(){
        ...
        <nav 
            ...
            <button 
                ...
                onClick={()=>this.navStyles()}
                style={(this.state.clicked===false)
                ?(this.state.visible.tablet.toggleBtn)
                :(this.state.hidden.tablet.toggleBtn)}>
            </button>
        </nav>
        <aside 
            className='nav-sidebar' 
                ...
                {(this.props.location.pathname===`/home-page`)
                    ...
                    :(<li 
                        ...
                        <Link 
                            to={`/home-page`} 
                            style={(this.state.clicked===false)
                            ?(this.state.hidden.tablet.sideBarUlLiA)
                            :(this.state.visible.tablet.sideBarUlLiA)}>
                            Home
                        </Link>
                    </li>)
                }
                ...
                {this.props.location.pathname===`/home-page`?null:
                    <li 
                        ...
                        <Link 
                            to={`/home-page`} 
                            style={(this.state.clicked===false)
                            ?(this.state.hidden.laptop.sideBarUlLiA)
                            :(this.state.visible.laptop.sideBarUlLiA)}>
                            Home
                        </Link>
                    </li>}
