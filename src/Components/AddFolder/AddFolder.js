...
class AddFolder extends React.Component {
        ...
        render() {
                ...
                return ( <
                        ...
                        style = { style.addFolderLabel } > Folder Name:
                        <
                        br / >
                        <
                        input type = 'text'
                        name = 'folderName'
                        style = { style.addFolderInput }
                        /> <
                        /label> <
                        br / >
                        <
                        ...
                        /> <
                        button type = 'submit'
                        style = { style.addFolderButtons } > Submit <
                        /button> <
                        /fieldset> <
                        /form>  {
                            (this.props.location.pathname === `/home-page`) ? null: < button onClick = {
                                () => this.props.history.push('/home-page') }
                            style = { style.addFolderButtons } > Cancel < /button>}  <
                                /div> <
                                /MediaQuery> <
                            ...
                            maxWidth = { 950 } >
                                <
                                div className = 'addFolder'
                            style = { style.tablet.addFolderDivStyle } >
                                <
                            ...
                            onSubmit = {
                                ...
                                label
                            htmlFor = 'folderName'
                            style = { style.tablet.addFolderLabel } >
                                Folder Name:
                                <
                                br / >
                                <
                                input type = 'text'
                            name = 'folderName'
                            style = { style.tablet.addFolderInput }
                            /></label >
                            <
                            br / >
                                <
                            ...
                            /> <
                            button type = 'submit'
                            style = { style.tablet.addFolderButtons } > Submit <
                                /button> <
                                /fieldset> <
                                /form>  {
                                    (this.props.location.pathname === `/home-page`) ? null: < button onClick = {
                                        () => this.props.history.push('/home-page') }
                                    style = { style.tablet.addFolderButtons } > Cancel < /button>}  <
                                        /div> <
                                        /MediaQuery> <
                                        MediaQuery minWidth = { 951 } >
                                        <
                                        div className = 'addFolder'
                                    style = { style.laptop.addFolderDivStyle } >
                                        <
                                    ...
                                    onSubmit = {
                                        ...
                                        <
                                        label htmlFor = 'folderName'
                                    style = { style.laptop.addFolderLabel } > Folder Name: < br / >
                                        <
                                        input type = 'text'
                                    name = 'folderName'
                                    style = { style.laptop.addFolderInput }
                                    /> <
                                    /label><br/ >
                                    <
                                    ValidationError Namemessage = { this.state.error }
                                    /> <
                                    button type = 'submit'
                                    style = { style.laptop.addFolderButtons } > Submit < /button> <
                                        /fieldset> <
                                        /form>  {
                                            (this.props.location.pathname === `/home-page`) ? null:
                                                ...
                                                button onClick = {
                                                    () => this.props.history.push('/home-page') }
                                            style = { style.laptop.addFolderButtons } > Cancel < /button>}  <
                                                /div> <
                                                /MediaQuery> <
                                                />
                                        )
