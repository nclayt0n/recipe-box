      ...
      <div 
        ...
        <form onSubmit={this.handleSubmit} >
            <fieldset style={style.registrationFormFieldset}>
                ...
                <button 
                  type='submit' 
                  style={style.registrationFormButtonA}>
                  Register
                </button>
                <br/>
                {(this.state.error==='Email is already in use')
                  ?(<button 
                    type='button' 
                    style={style.registrationFormButtonA}>
                    <Link 
            ...
            <fieldset style={style.registrationFormFieldset}>
                ...
                <label 
                  ...
                  <input 
                    type='text' 
                    name='full_name' 
                    style={style.registrationFormInputTablet}/>
                </label>
                <br/>
                <label 
                  htmlFor='email' 
                  style={style.registrationFormLabel}>Email:<br/>
                  <input 
                    type='text' 
                    name='email' 
                    style={style.registrationFormInputTablet}/>
            ...
            <fieldset style={style.registrationFormFieldset}>
                ...
                <label 
                  ...
                  <input 
                    type='text' 
                    name='full_name' 
                    style={style.registrationFormInputLaptop}/>
                </label>
                <br/>
                <label 
                  htmlFor='email' 
